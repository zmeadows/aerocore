...
public:
    ...
    TranslationSystem(ComponentManager* const CM_)
        : System("Translation", CM_)
    {
...
public:
    ...
    RotationSystem(ComponentManager* const CM_)
        : System("Rotation", CM_)
    {
...
public:
    ...
    CollisionSystem(ComponentManager* const CM_)
        : System("Collision", CM_)
    {
